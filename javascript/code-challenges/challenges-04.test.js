...
const alphabetizeBetter = (arr) => {
  let newArr = arr.sort((a, b) => a.toLowerCase() < b.toLowerCase() ? -1 : 1);
  return newArr;
};
...
const sortNumbersByLength = (arr) => {
  let newArr = arr.sort((a, b) => a.toString().length - b.toString().length);
  return newArr;
};
...
const sortPeople = (arr) => {
  let newArr = arr.sort((a, b) => a.lastName < b.lastName ? -1 : 1);
  return newArr;
};
